...
export const consoleSystem = {
    ...
    init() {
        ...
        }).catch(err => console.error("Failed to load console commands:", err)); // Add error handling
    },
    ...
    initCommands() {
        ...
        this.commands.help = (args) => {
            ...
            this.log('ai_speech_toggle - Toggle AI cursor speech bubbles');
            this.log('toggle_indicators - Toggle number indicators on/off');
            this.log('toggle_cursor - Toggle custom player cursor on/off'); 
            this.log('potato_mode - Toggle low performance mode'); 
        ...
        this.commands.help_ai_speech_toggle = () => { 
            this.log('ai_speech_toggle - Toggles the display of AI cursor speech bubbles on/off.', 'info');
            this.log('  When disabled, AI cursors will not show speech bubbles.', 'info');
        };

        this.commands.help_toggle_indicators = () => {
            this.log('toggle_indicators - Toggles the display of floating number indicators on/off.', 'info');
            this.log('  When disabled, numbers like +$1 or -5 R$ will not appear on clicks.', 'info');
        };

        this.commands.help_toggle_cursor = () => {
             this.log('toggle_cursor - Toggles the custom player cursor on/off.', 'info');
             this.log('  When disabled, the default system cursor will be shown.', 'info');
        };

        this.commands.help_potato_mode = () => {
            this.log('potato_mode - Toggles low performance mode on/off.', 'info');
            this.log('  Reduces animations, effects, and AI update rates for better performance.', 'info');
        };
        ...
        }).catch(err => this.log(`Error loading AI module for console: ${err.message}`, 'error'));
    }
};